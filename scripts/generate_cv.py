...
DEMAND_NODES = [
    ...
    (15.8900, 108.2500, "Dien_Ban_District"),
    (15.4500, 108.6200, "Nui_Thanh_District"),
    (15.7077, 108.3969, "Thang_Binh_District"),
    (15.8339, 107.9544, "Dai_Loc_District"),
    (15.9126, 107.7265, "Dong_Giang_District"),
    (15.8948, 107.4976, "Tay_Giang_District"),
    (16.2185, 107.3318, "A_Luoi_District"),    # +0.005°N -0.005°E offset from hub centroid
    (15.6072, 107.6071, "Nam_Giang_District"),
    (15.9400, 107.5800, "A_Vuong_Commune"),
    (15.5800, 108.1400, "Viet_An_Commune"),
    (15.6832, 108.0627, "Que_Son_District"),
    (15.5800, 108.3200, "Phu_Ninh_District"),
    (15.5722, 108.4744, "Tam_Ky_City"),
    ...
    (16.0169, 108.2033, "Cam_Le_District"),
    (16.1216, 108.1126, "Lien_Chieu_District"),
    (16.1033, 108.2638, "Son_Tra_District"),
    (16.0540, 108.1860, "Thanh_Khe_District"),
    (16.0667, 107.9738, "Hoa_Vang_District"),
    # ── Quảng Nam inland / highland ────────────────────────────────────────
    (15.7000, 108.3000, "Phu_Yen_Commune"),
    (15.3200, 107.9500, "Bac_Tra_My"),
    (15.1400, 108.1200, "Nam_Tra_My"),
    (15.5181, 108.1028, "Hiep_Duc_District"),
    (15.4916, 108.2986, "Tien_Phuoc_District"),
    ...
    # ── Đà Nẵng wards ──────────────────────────────────────────────────────
    (16.1000, 108.2200, "Tho_Quang_Ward"),              # Son Tra peninsula, Da Nang bay side
    (16.0416, 108.2175, "Hoa_Cuong_Ward"),
    (15.9500, 108.0500, "An_Tan_Commune"),
    (15.9600, 107.8500, "Lac_My_Commune"),
    (16.3500, 107.5500, "Hong_Ha_Commune"),
    (16.4800, 107.6800, "Quang_An_Ward"),
    ...
    (15.6300, 107.3700, "A_La_Commune"),
    (16.7000, 107.1500, "Cao_Ngan_Commune"),
    (14.9884, 108.8877, "Mo_Duc_District"),
    (14.9463, 108.6762, "Minh_Long_District"),   # fixed: was "10 8.7801"
    (15.4000, 108.7000, "Chu_Lai_Port_Area"),
    (15.0300, 108.4700, "Son_Ha_District"),
    (14.9702, 108.3555, "Son_Tay_District"),
    (15.2093, 108.4534, "Tra_Bong_District"),
    (14.9689, 108.7984, "Nghia_Hanh_District"),
    (15.0914, 108.7676, "Tu_Nghia_District"),
    (15.1190, 108.8096, "Quang_Ngai_City"),
    (15.1986, 108.7085, "Son_Tinh_District"),
    (15.3115, 108.7287, "Binh_Son_District"),
    ...
    (15.4686, 107.9180, "Phuoc_Hiep_Commune"),
    (16.0800, 108.1200, "Hoa_Lien_Commune"),         # Hoa Vang district inland, not in sea
    (15.9800, 108.1900, "Hoa_Tien_Commune"),              # Hoa Tien, Hoa Vang lowland (~108.19°E)
    (15.6500, 107.5500, "Zuoih_Commune"),
    (15.5500, 107.4500, "Bha_Le_Commune"),
...
HUB_NODES = [
    ...
    (15.5722, 108.4744, "Tam_Ky_Logistics_Hub"),
    (16.2135, 107.3368, "A_Luoi_Relief_Center"),
    ...
    (15.0300, 108.4700, "Son_Ha_Hub"),               # Son Ha district center, Quang Ngai
]  # 20 nodes
...
ORIGIN_NODES = [
    ...
    (16.6300, 106.7300, "Khe_Sanh_Entry"),          # western highland border entry
    (15.2093, 108.4534, "Tra_Bong_Supply"),         # inland supply depot
