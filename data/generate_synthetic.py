...
ALL_REAL_NODES = [
    ...
    (16.0601, 108.2411, "My_Khe_Beach_Area",       "demand"),
    (16.9321, 107.3012, "A_Dot_Commune",           "demand"),
    (15.4501, 108.5801, "Tam_Quan_Town",           "demand"),
    ...
    (15.5501, 108.5401, "Truong_Giang_Commune",    "demand"),
    (17.0721, 107.6231, "Son_Qua_Commune",         "demand"),
    (15.9301, 108.4521, "Xuan_Ha_Ward",            "demand"),
    (16.0851, 108.2441, "Man_Thai_Ward",           "demand"),
    (15.5601, 107.9151, "Phuoc_Hiep_Commune",      "demand"),
