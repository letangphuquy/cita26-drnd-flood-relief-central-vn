...
python scripts\map_solution_detailed.py --instance data\cv\cv_large_drnd.json --flow results\exp2\cv_large_flow.json --out figures\cv_large_map_detailed.pdf
```
